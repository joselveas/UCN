...
int main()
{
    ListaNexoSimpleCircular* lista = new ListaNexoSimpleCircular();
    bool menu = true;
    do{
        ...
        switch(opcion)
        {
            case 1:
                ...
                cin>>valor;
                lista->insertarInicio(new NodoSimple(valor));
                cout<<"Se ha ingresado el dato: "<<valor<<endl;
                break;
            case 2:
                cout<<"Ingresar el valor"<<endl;
                cin>>valor;
                lista->insertarFinal(new NodoSimple(valor));
                cout<<"Se ha ingresado el dato: "<<valor<<endl;
                break;
            case 3:
                if(lista->listaVacia())
            ...
            case 5:
            {
                ...
                NodoSimple* aux = lista->buscarNodo(valor);
                if(aux == NULL)
                {
            ...
            case 6:
            {
                NodoSimple *aux = lista -> getPrimero();
                if(aux == NULL)
                {
